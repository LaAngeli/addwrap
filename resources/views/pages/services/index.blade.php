                        ...
                        >
                            ...
                            <div class="mt-8 flex flex-col gap-4 border-t border-zinc-200 pt-6 sm:flex-row sm:items-center sm:justify-between">
                                ...
                                <div class="flex flex-col gap-3 sm:flex-row">
                                    <a href="{{ Localization::serviceUrl($key) }}" class="rounded-lg bg-zinc-900 px-5 py-2.5 text-center text-sm font-semibold text-white transition hover:bg-black">{{ __('services.index.view_service') }}</a>
