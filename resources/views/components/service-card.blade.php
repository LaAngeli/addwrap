...
<a
    ...
    class="group flex flex-col rounded-2xl border border-zinc-200 bg-white p-5 transition hover:-translate-y-1 hover:border-zinc-900 hover:shadow-xl sm:p-6"
>
    <span class="mb-4 inline-flex h-11 w-11 items-center justify-center rounded-xl bg-deep text-white transition group-hover:scale-105 sm:mb-5 sm:h-12 sm:w-12">
