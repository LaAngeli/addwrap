...
>
    <span class="mb-4 inline-flex h-11 w-11 items-center justify-center rounded-xl bg-teal text-white transition group-hover:scale-105 sm:mb-5 sm:h-12 sm:w-12">
