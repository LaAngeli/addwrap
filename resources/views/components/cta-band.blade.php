...
<section class="relative overflow-hidden bg-teal-ink">
    <div class="bg-dot-grid pointer-events-none absolute inset-0 text-white opacity-[0.12]"></div>

    {{-- Glow de brand (portocaliu + halo turcoaz) pe fundal teal închis --}}
    <div class="pointer-events-none absolute -left-24 -top-24 h-72 w-72 rounded-full bg-orange opacity-20 blur-3xl"></div>
    <div class="pointer-events-none absolute -bottom-28 -right-16 h-80 w-80 rounded-full bg-paper opacity-20 blur-3xl"></div>
