...
--}}
<div {{ $attributes->merge(['class' => 'relative flex w-full flex-col overflow-hidden rounded-2xl bg-gradient-to-br from-teal to-teal-deep '.($tall ? 'aspect-[16/10]' : 'aspect-[16/9]')]) }}>
