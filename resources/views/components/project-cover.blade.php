...
--}}
<div {{ $attributes->merge(['class' => 'relative flex w-full flex-col overflow-hidden rounded-2xl bg-gradient-to-br from-zinc-900 to-zinc-800 '.($tall ? 'aspect-[16/10]' : 'aspect-[16/9]')]) }}>
