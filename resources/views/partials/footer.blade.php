                    ...
                    <div class="mt-6 flex items-center justify-center gap-3">
                        @foreach ($social as $network => $url)
                            ...
                            <a href="{{ $url }}" @if ($url !== '#') target="_blank" rel="noopener noreferrer" @endif
                                ...
                                class="inline-flex h-10 w-10 items-center justify-center rounded-full border border-zinc-200 text-zinc-600 transition hover:border-zinc-900 hover:bg-deep hover:text-white">
